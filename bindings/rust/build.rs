fn main() {
    ...
    c_config.compile("tree-sitter-galley");

    println!("cargo:rustc-check-cfg=cfg(with_highlights_query)");
    if !"queries/galley/highlights.scm".is_empty() && std::path::Path::new("queries/galley/highlights.scm").exists() {
    ...
    if !"queries/galley/tags.scm".is_empty() && std::path::Path::new("queries/galley/tags.scm").exists() {
